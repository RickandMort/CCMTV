...
public class ExamStudentListAdapter extends BaseAdapter{
    ...
    private List<ExamStudent> list;
    private String flag;

    public ExamStudentListAdapter(Context context, List<ExamStudent> list,String flag) {
        this.context = context;
        this.list = list;
        this.flag=flag;
    }

    public void notifyData(List<ExamStudent> list){
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final ExamStudent examStudent = list.get(position);

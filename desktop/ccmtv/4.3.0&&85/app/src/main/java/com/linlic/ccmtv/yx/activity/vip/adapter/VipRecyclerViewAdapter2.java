 ...
 * data：2017/7/13.
 */
public class VipRecyclerViewAdapter2 extends
        RecyclerView.Adapter<VipRecyclerViewAdapter2.ViewHolder> implements View.OnClickListener{
    private LayoutInflater mInflater;
    private List<Map<String ,Object>> arrays;
    private int selectIndex = -1;
    //声明自定义的监听接口
    private OnRecyclerviewItemClickListener mOnRecyclerviewItemClickListener = null;
    public VipRecyclerViewAdapter2(Context context, List<Map<String ,Object>>  arrays,OnRecyclerviewItemClickListener mOnRecyclerviewItemClickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.vip_rcview_item2,
                viewGroup, false);

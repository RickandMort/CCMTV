...
import com.linlic.ccmtv.yx.activity.subscribe.ViewPageInfo;
import com.linlic.ccmtv.yx.activity.subscribe.smallfragment.PagerSlidingTabStrip;
...
public class ViewPageFragmentAdapter extends FragmentPagerAdapter implements
	...
	public void onPageScrolled(int position, float positionOffset,
		...
		LogUtil.e("position", "position"+position+"positionOffset"+positionOffset+"positionOffsetPixels"+positionOffsetPixels);
	}

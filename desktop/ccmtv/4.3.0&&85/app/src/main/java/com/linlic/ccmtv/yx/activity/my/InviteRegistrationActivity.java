...
//                        refreshLayout.finishRefresh( false);
    ...
    public void initData(){
        ...
        map.put("title1","步骤一");
        map.put("title2","分享给好友");
        map.put("type",1);
        data.add(map);

        Map<String, Object> map1 = new HashMap<>();
        map1.put("title1","步骤二");
        map1.put("title2","好友完成注册赚50积分/人");
        map1.put("type",1);
        data.add(map1);
...
//                    Log.e("分享视频",result);
    ...
    public void toinvite( ) {
        Intent intent = new Intent(InviteRegistrationActivity.this, MyInvitationFriend.class);

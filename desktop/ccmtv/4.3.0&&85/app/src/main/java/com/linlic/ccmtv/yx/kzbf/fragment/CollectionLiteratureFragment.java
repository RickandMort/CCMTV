...
import static com.linlic.ccmtv.yx.R.id.inbox_list;

/**
 * 收藏-指南文献
 */
//item_collection
public class CollectionLiteratureFragment extends BaseFragment {
    private int page = 1;
    private int count;
...
//                            Toast.makeText(getActivity(), jsonObject.getString("msg"), Toast.LENGTH_SHORT).show();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_collection_literature, container, false);
    }
    ...
    private void initView() {
        recyclerView = (RecyclerView) getActivity().findViewById(R.id.cl_list);
        lt_nodata1 = (RelativeLayout) getActivity().findViewById(R.id.rl_literature_nodata1);
    }
...
//                    Log.e("看看文献收藏箱数据", result);
    ...
    private void setBean(JSONObject jsonObject) throws JSONException {
        ...
        dbCt.setCid(jsonObject.getString("cid"));
    }

...
public class Training_management2 extends BaseActivity {
    ...
    @Bind(R.id.tranining_nodata)
    NodataEmptyLayout tranining_nodata;
                        ...
                        if (jsonObject.getInt("code") == 200) {
                            ...
                            if (dataJson.getInt("status") == 1) { // 成功
                                ...
                                for (int i = 0; i < dateJson.length(); i++) {
                                    ...
                                    map.put("sign", dataJson1.getString("sign"));
                                    listData.add(map);
                                }
                    ...
                    try {
                        ...
                        if (jsonObject.getInt("code") == 200) {
                            ...
                            if (dataJson.getInt("status") == 1) { // 成功
                                ...
                                if (intent != null) {
                                    is_new_teaching_activities = true;
...
//
    ...
    private void setResultStatus(boolean status, int code) {
        if (status) {
            ...
            tranining_nodata.setVisibility(View.GONE);
        } else {
            if (HttpClientUtils.isNetConnectError(context, code)) {
                tranining_nodata.setNetErrorIcon();
            } else {
                tranining_nodata.setLastEmptyIcon();
            }
            training_list.setVisibility(View.GONE);
            tranining_nodata.setVisibility(View.VISIBLE);
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.training_management);
        context = this;
...
//
                switch (map.get("sign").toString()) {
                    case "1":
                        if (map.get("status").toString().equals("2")) {
                            helper.setText(R.id._item_button, "签到");
                            ...
                            helper.setText(R.id._item_button, "未签到");
                        ...
                        break;
                    case "2":
                        helper.setText(R.id._item_button, "已签到");
                        helper.setBackground_Image(R.id._item_button, R.mipmap.training_06);
                        helper.setTextColor2(R.id._item_button, Color.parseColor("#666666"));
                        break;
                    case "3":
                        helper.setText(R.id._item_button, "已请假");
                        helper.setBackground_Image(R.id._item_button, R.mipmap.training_06);
                        helper.setTextColor2(R.id._item_button, Color.parseColor("#666666"));
                        break;
                    case "4":
...
//        the_activity_type.setTextColor(Color.parseColor("#626262"));
        the_activity_type.setTextColor(Color.parseColor("#666666"));
        the_activity_type_icon.setImageResource(R.mipmap.training_08);
        time_to_screen.setTextColor(Color.parseColor("#666666"));
        time_to_screen_icon.setImageResource(R.mipmap.training_08);

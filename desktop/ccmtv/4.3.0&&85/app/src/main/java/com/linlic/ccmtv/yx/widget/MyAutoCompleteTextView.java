...
public class MyAutoCompleteTextView extends AutoCompleteTextView {
     ...
     */
    public void setFatherRelativeLayout(RelativeLayout layout) {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            if (mList.size() > 0) {
                ...
                if (!popView.isShown()) {
                    ...
                    layoutParams.topMargin = top[1] +10;
    ...
    private void setPopw() {
        if (this.popView == null) {
            popView = View.inflate(context, R.layout.drop_down_layout, null);
        }

        if (mlistView == null) {
            mlistView = (ListView) popView.findViewById(R.id.listview_history);
        ...
        if (mAdapter == null) {
            mAdapter = new ArrayAdapter<String>(context, R.layout.history_user, R.id.history_username, mList);
        }

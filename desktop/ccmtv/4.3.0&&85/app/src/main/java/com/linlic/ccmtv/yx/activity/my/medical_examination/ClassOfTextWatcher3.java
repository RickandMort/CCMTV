 ...
 */
public  class ClassOfTextWatcher3 implements TextWatcher {

    private EditText view;
    private Problem problem ;

    public ClassOfTextWatcher3(View view, Problem problem ) {
    ...
    public void afterTextChanged(Editable s) {
        ...
        if(stringList.size()>0){
            if(stringList.size()>1){
                ...
                MyDbUtils.saveExamination_script(view.getContext(), textView2.getText().toString(),problem.getTitle_serial_number(), sss);
            }else{
                MyDbUtils.saveExamination_script(view.getContext(), textView2.getText().toString(), problem.getTitle_serial_number(), stringList.get(0));
            }
            problem.setUser_answer( stringList.get(0));
        }else{
            problem.setUser_answer("");
            MyDbUtils.deleteExamination_scriptALL(view.getContext(),textView2.getText().toString(),problem.getTitle_serial_number());
        }
    }

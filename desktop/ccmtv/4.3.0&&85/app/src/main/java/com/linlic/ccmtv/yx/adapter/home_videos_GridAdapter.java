 ...
 */
public class home_videos_GridAdapter  extends BaseAdapter {
	private Context mContext;
	public List<Home_Video> videos ;
	public home_videos_GridAdapter(Context mContext, List<Home_Video> videos ) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		order_num = BaseViewHolder.get(convertView, R.id.order_num);
		//第一步设置视频ID

 ...
 * 提现记录
 */
public class Cashier_present_record extends BaseActivity {
    Context context;
                        ...
                        if (result.getInt("status") == 1) {//成功
                            ...
                            if (dataArray.length() == 0) {
                                ...
                                for (int i = 0; i < dataArray.length(); i++) {
                                    ...
                                    map.put("get_integral_item_reason", object.getString("bank"));
                                    map.put("get_integral_item_increase", object.getString("drawmoney"));
                                    map.put("get_integral_item_time", object.getString("flgstr") + "\n" + object.getString("drawtime"));

                                    data.add(map);

                                }
                                adapter = new SimpleAdapter(Cashier_present_record.this, data,
                            ...
                            Toast.makeText(Cashier_present_record.this, result.getString("errorMessage"), Toast.LENGTH_SHORT).show();
                        }
                    } catch (Exception e) {
                    }
                    break;
                case 500:
                    Toast.makeText(Cashier_present_record.this, R.string.post_hint1, Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cashier_present_record);
        context = this;
        findId();
        super.setActivity_title_name("提现记录");
        setText();
        setmsgdb();
    }
    ...
    public void setText() {
        ...
        String UserName = SharedPreferencesTools.getUserName(Cashier_present_record.this);
        cashier_revenue_log_author.setText(UserName);
        //显示头像
        String Str_icon = SharedPreferencesTools.getStricon(Cashier_present_record.this);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (uid == null || "".equals(uid)) {
                    startActivity(new Intent(Cashier_present_record.this, LoginActivity.class));
                }

                try {
                    JSONObject obj = new JSONObject();
                    obj.put("uid", uid);
                    obj.put("act", URLConfig.cashierCashquery);

                    String result = HttpClientUtils.sendPost(Cashier_present_record.this,
    ...
    public void loadImg(ImageView img, String path) {
        ...
        XUtilsImageLoader xUtilsImageLoader = new XUtilsImageLoader(Cashier_present_record.this);

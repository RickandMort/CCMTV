...
public class RelatedliteratureAdapter extends BaseMultiItemQuickAdapter<DbMedicine, BaseViewHolder> {
    private Context mContext;

    public RelatedliteratureAdapter(Context context, List data) {
        super(data);
        mContext = context;
        addItemType(DbMedicine.TYPE_PIC_3, R.layout.item_literature1);
        addItemType(DbMedicine.TYPE_PIC_0, R.layout.item_literature2);
    ...
    protected void convert(BaseViewHolder helper, DbMedicine item) {
        switch (helper.getItemViewType()) {
            case DbMedicine.TYPE_PIC_3://3张图片
                ...
                helper.setText(R.id.literature_title1, item.getTitle())
                        .setText(R.id.literature_describe1, item.getDescribe())
                        .setText(R.id.literature_eye_num1, item.getLook_num())
                        .setText(R.id.literature_posttime1, item.getPosttime());
...
//                }
            ...
            case DbMedicine.TYPE_PIC_0://没有图片
                helper.setText(R.id.literature_title2, item.getTitle())
                        .setText(R.id.literature_describe2, item.getAuthor())
                        .setText(R.id.literature_describe22, item.getSource())
                        .setText(R.id.literature_eye_num2, item.getLook_num())
                        .setText(R.id.literature_posttime2, item.getPosttime());
                /*if (item.getDescribe().equals("")) {
                    helper.setVisible(R.id.literature_describe2, false);
                }*/
...
//                }
            ...
            case DbMedicine.TYPE_PIC_1://1张图片
                ...
                helper.setText(R.id.literature_title3, item.getTitle())
                        .setText(R.id.literature_describe3, item.getDescribe())
                        .setText(R.id.literature_eye_num3, item.getLook_num())
                        .setText(R.id.literature_posttime3, item.getPosttime());
                if (item.getDescribe().equals("")) {

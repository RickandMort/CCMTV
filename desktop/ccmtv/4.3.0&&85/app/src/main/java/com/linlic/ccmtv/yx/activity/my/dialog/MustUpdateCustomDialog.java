 ...
 * data：2016/6/1.
 */
public class MustUpdateCustomDialog extends Dialog implements
     ...
     * 自定义布局的构造方法
     */
    public MustUpdateCustomDialog(Context context, int resLayout) {
        super(context);
     ...
     * 自定义主题及布局的构造方法
     */
    public MustUpdateCustomDialog(Context context, int theme, int resLayout, String str_tip) {
        super(context, theme);
        this.context = context;
        this.layoutRes = resLayout;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.confirm_btns:
                ...
                MustUpdateCustomDialog.this.dismiss();
                // 构造软件下载对话框

...
public class SearchView extends EditText {
    ...
    private void InitResource(Context context, AttributeSet attrs) {
        ...
        textColor = mTypedArray.getColor(R.styleable.searchedit_search_textSize, 0xFF848484);
        textSize = mTypedArray.getDimension(R.styleable.searchedit_search_textSize, 14 * density + 0.5F);
        mTypedArray.recycle();
    }

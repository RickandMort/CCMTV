...
public class GpGraduateToDailyExamActivity extends BaseActivity implements View.OnClickListener {
    ...
    private LinearLayout llStuTopLayout, llStuDepartment, llStuTeacher;
    ...
    private TextView tvStuDepartment, tvStuTeacher;
                    ...
                    try {
                        ...
                        if (result.getString("code").equals("200")) { // 成功
                            ...
                            if (data.getString("status").equals("1")) {
                                ...
                                stuScore = dataObject.getString("score");
                                fen_time = dataObject.getString("fen_time");
                                comments = dataObject.getString("msg");
                                stuName = dataObject.getString("gpname");
                                teacherName = dataObject.getString("djteacher");
                                standard_name = dataObject.getString("standard_name");

                                /*stuName = dataObject.getString("user_name");
                                standard_name = dataObject.getString("standard_name");
                                upd_status = dataObject.getString("upd_status");
                                promptHtml = dataObject.getString("html");

                                if (dataObject.has("details")) {
                                    JSONObject detailObject = dataObject.getJSONObject("details");
                                ...
                                if (dataObject.has("content")) {
                                    String contentString = dataObject.getString("content");
...
//                                    daily_exam_of_item.setId(listObject.getString("id"));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graduate_to_daily_exam);
    ...
    public void findId() {
        ...
        tvScore = (TextView) findViewById(R.id.id_tv_graduate_exam_score);
        tvPrompt = (TextView) findViewById(R.id.id_tv_graduate_exam_prompt);
        tvCancel = (TextView) findViewById(R.id.id_tv_graduate_exam_cancel);
        tvSubmit = (TextView) findViewById(R.id.id_tv_graduate_exam_submit);
        etComments = (EditText) findViewById(R.id.id_et_graduate_exam_comments);
        lvQuestion = (ListView) findViewById(R.id.id_lv_graduate_exam_question);
        llButtonLayout = (LinearLayout) findViewById(R.id.id_ll_graduate_exam_button_layout);

        llStuTopLayout = (LinearLayout) findViewById(R.id.id_ll_graduate_exam_stu_top_layout);
        llStuDepartment = (LinearLayout) findViewById(R.id.id_ll_graduate_exam_stu_department);
//        llStuDoctorOfficer = (LinearLayout) findViewById(R.id.id_ll_graduate_exam_stu_doctor_officer);
        llStuTeacher = (LinearLayout) findViewById(R.id.id_ll_graduate_exam_stu_teacher);
//        llStuHeadNurse = (LinearLayout) findViewById(R.id.id_ll_graduate_exam_stu_head_nurse);
        llDoctorTopLayout = (LinearLayout) findViewById(R.id.id_ll_graduate_exam_doctor_top_layout);
        llDoctorMarkDate = (LinearLayout) findViewById(R.id.id_ll_graduate_exam_doctor_mark_date);
        llDoctorDepartment = (LinearLayout) findViewById(R.id.id_ll_graduate_exam_doctor_department);
        llDoctorTeacher = (LinearLayout) findViewById(R.id.id_ll_graduate_exam_doctor_doctor_teacher);
//        llDoctorHeadNurse = (LinearLayout) findViewById(R.id.id_ll_graduate_exam_doctor_head_nurse);
//        llDoctorofficer = (LinearLayout) findViewById(R.id.id_ll_graduate_exam_doctor_doctor_officer);
        llDoctorStudent = (LinearLayout) findViewById(R.id.id_ll_graduate_exam_doctor_student);
        tvStuDepartment = (TextView) findViewById(R.id.id_tv_graduate_exam_stu_department);
//        tvStuDoctorOfficer = (TextView) findViewById(R.id.id_tv_graduate_exam_stu_doctor_officer);
        tvStuTeacher = (TextView) findViewById(R.id.id_tv_graduate_exam_stu_teacher);
//        tvStuHeadNurse = (TextView) findViewById(R.id.id_tv_graduate_exam_stu_head_nurse);
        tvDoctorMarkDate = (TextView) findViewById(R.id.id_tv_graduate_exam_doctor_mark_date);
        tvDoctorDepartment = (TextView) findViewById(R.id.id_tv_graduate_exam_doctor_department);
        tvDoctorTeacher = (TextView) findViewById(R.id.id_tv_graduate_exam_doctor_doctor_teacher);
        tvDoctorStudent = (TextView) findViewById(R.id.id_tv_graduate_exam_doctor_student);
//        spinnerDoctorHeadNurse = (NiceSpinner) findViewById(R.id.id_spinner_graduate_exam_doctor_head_nurse);
//        spinnerDoctorofficer = (NiceSpinner) findViewById(R.id.id_spinner_graduate_exam_doctor_doctor_officer);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.id_tv_graduate_exam_cancel:
//                setCancel();
                finish();
                break;
        }
    ...
    private void initDatas() {
        try {
            daily_exam_details_id = getIntent().getStringExtra("daily_exam_details_id");
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    obj.put("act", URLConfig.getDailyScoreFromLeaveKs);
                    obj.put("uid", SharedPreferencesTools.getUid(context));
                    obj.put("daily_exam_details_id", daily_exam_details_id);
                    String result = HttpClientUtils.sendPostToGP(context, URLConfig.CCMTVAPP_GpApi, obj.toString());
                    LogUtil.e("规培出科跳转日常考核信息数据：", result);

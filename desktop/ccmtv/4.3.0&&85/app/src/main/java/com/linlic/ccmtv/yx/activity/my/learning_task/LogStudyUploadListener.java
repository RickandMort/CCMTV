...
import com.linlic.ccmtv.yx.activity.upload.IsUpload2;
...
class LogStudyUploadListener<T> extends UploadListener<T> {

    Context context= LocalApplication.getAppContext();
    private NumberFormat nf = NumberFormat.getPercentInstance();

    public LogStudyUploadListener() {
        super("LogStudyUploadListener");
    }
...
//        Log.e("LogUploadListener", "onFinish: 上传完成");
    ...
    public void MyNotificationCase(Context context, String tan, String title, String cont, boolean isProgress) {
        ...
        Notification notify = new Notification.Builder(context)
                ...
                .setContentText(cont).setNumber(1).build();

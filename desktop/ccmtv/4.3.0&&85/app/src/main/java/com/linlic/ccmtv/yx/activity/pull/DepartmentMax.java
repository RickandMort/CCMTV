 ...
 */
public class DepartmentMax extends BaseActivity {
            ...
            switch (msg.what) {
                case 200:
                    SimpleAdapter adapter = new SimpleAdapter(
                            DepartmentMax.this, list, R.layout.hospital_item,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //设置顶部导航文字
        activity_title_name.setText(R.string.depa_max);
        ...
        listview.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View view, int arg2, long arg3) {
                ...
                Intent intent = new Intent(DepartmentMax.this, DepartmentMin.class);
                Bundle bundle = new Bundle();
                bundle.putString("departmentMaxId", viewID.getText().toString());
                bundle.putString("departmentMaxName", viewName.getText().toString());

...
/**
 * Created by bentley on 2019/4/22.
 */

public class Adapter_GpBaseDailyExam extends BaseAdapter{

    private Context context;
    private List<BaseDailyStudent> list;
    private String flag;

    public Adapter_GpBaseDailyExam(Context context, List<BaseDailyStudent> list,String flag) {
        this.context = context;
        this.list = list;
        this.flag=flag;
    }

    public void notifyData(List<BaseDailyStudent> list){
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final BaseDailyStudent examStudent = list.get(position);
        holder.tvStudentName.setText(examStudent.getRealname());
        holder.tvStudentDepartment.setText(examStudent.getStandard_kname());

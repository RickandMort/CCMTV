...
//                selectedTab(currentPosition); // 选中指定位置的TAB
                ViewGroup tabsLayout = getTabsLayout();
                if (currentPosition > -1 && tabsLayout != null
                        && currentPosition < tabsLayout.getChildCount()) {
                    ...
                    currentSelectedTabView = tabsLayout.getChildAt(currentPosition);
                    if (currentSelectedTabView != null) {
    ...
    public void onClick(View v) {
      ...
      /*  Message msg = new Message();
        msg.what = 1;
        msg.obj = index;
        TestFragmentOne.handler.sendMessage(msg);*/
    }
    ...
    private void selectedTab(int currentSelectedTabPosition) {
        ...
        if (currentSelectedTabPosition > -1 && tabsLayout != null
         ...
         /*   TestFragmentOne testFragmentOne = new TestFragmentOne();
            testFragmentOne.index = currentSelectedTabPosition;*/
            Intent mIntent = new Intent("sub");
            mIntent.putExtra("position", currentSelectedTabPosition);

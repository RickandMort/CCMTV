 ...
 * data：2016/5/5 15:57
 */
public class MyCaseActivity2 extends BaseActivity implements View.OnClickListener {
    DbUploadCase dbUploadCase;
    UploadCaseDetail uploadCaseDetail;
    ...
    private List<String> uploadFileAList;
    private List<String> uploadFileBList;
    private List<String> uploadFileCList;
    private List<String> uploadFileDList;
    private List<String> uploadFileEList;
    private List<String> uploadFileFList;
    private List<String> uploadFileGList;
    private List<String> uploadFileHList;
    ...
    private void initData() {
        ...
        uploadCaseDetail = (UploadCaseDetail) bundle.getSerializable("uploadCaseDetail");
//        Log.i("uploadCaseDetail", uploadCaseDetail.toString());
        uploadCaseList = uploadCaseDetail.getData();
    ...
    public void setText() {
        ...
        tv_case_title.setText(uploadCaseDetail.getMvtitle());

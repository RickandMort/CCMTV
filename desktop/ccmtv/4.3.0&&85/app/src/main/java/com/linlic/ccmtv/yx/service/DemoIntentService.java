...
public class DemoIntentService extends GTIntentService {
    ...
    public void onReceiveServicePid(Context context, int pid) {
        LogUtil.e(TAG, "onReceiveServicePid -> " + pid);
    }
    ...
    public void onReceiveMessageData(Context context, GTTransmitMessage msg) {
        ...
        boolean result = PushManager.getInstance().sendFeedbackMessage(context, taskid, messageid, 90001);
         LogUtil.e(TAG, "call sendFeedbackMessage = " + (result ? "success" : "failed"));

         LogUtil.e(TAG, "onReceiveMessageData -> " + "appid = " + appid + "\ntaskid = " + taskid + "\nmessageid = " + messageid + "\npkg = " + pkg
                + "\ncid = " + cid);
...
//             LogUtil.e(TAG, "receiver payload = " + data);
    ...
    public void onReceiveClientId(Context context, String clientid) {
        ...
        SharedPreferencesTools.savePush_id(context,clientid);
    ...
    public void onReceiveCommandResult(Context context, GTCmdMessage cmdMessage) {
         LogUtil.e(TAG, "onReceiveCommandResult -> " + cmdMessage);
    ...
    public void onNotificationMessageArrived(Context context, GTNotificationMessage message) {
         LogUtil.e(TAG, "onNotificationMessageArrived -> " + "appid = " + message.getAppid() + "\ntaskid = " + message.getTaskId() + "\nmessageid = "
    ...
    public void onNotificationMessageClicked(Context context, GTNotificationMessage message) {
         LogUtil.e(TAG, "onNotificationMessageClicked -> " + "appid = " + message.getAppid() + "\ntaskid = " + message.getTaskId() + "\nmessageid = "
                + message.getMessageId() + "\npkg = " + message.getPkgName() + "\ncid = " + message.getClientId() + "\ntitle = "
                + message.getTitle() + "\ncontent = " + message.getContent());
    }
    ...
    private void setTagResult(SetTagCmdMessage setTagCmdMsg) {
        ...
        switch (Integer.valueOf(code)) {
         ...
         LogUtil.e(TAG, "settag result sn = " + sn + ", code = " + code + ", text = " + getResources().getString(text));
    }
    ...
    private void bindAliasResult(BindAliasCmdMessage bindAliasCmdMessage) {
        ...
        switch (Integer.valueOf(code)) {
         ...
         LogUtil.e(TAG, "bindAlias result sn = " + sn + ", code = " + code + ", text = " + getResources().getString(text));
    ...
    private void unbindAliasResult(UnBindAliasCmdMessage unBindAliasCmdMessage) {
        ...
        switch (Integer.valueOf(code)) {
         ...
         LogUtil.e(TAG, "unbindAlias result sn = " + sn + ", code = " + code + ", text = " + getResources().getString(text));
    ...
    private void feedbackResult(FeedbackCmdMessage feedbackCmdMsg) {
        ...
        String cid = feedbackCmdMsg.getClientId();
         ...
         LogUtil.e(TAG, "onReceiveCommandResult -> " + "appid = " + appid + "\ntaskid = " + taskid + "\nactionid = " + actionid + "\nresult = " + result
                + "\ncid = " + cid + "\ntimestamp = " + timestamp);
    }
    ...
    private void sendMessage(String data, int what) {
        ...
        msg.what = what;
        msg.obj = data;
        LocalApplication.sendMessage(msg);
    }
}

...
public class UploadingAdapter3 extends RecyclerView.Adapter<UploadingAdapter3.ViewHolder> {

    public static final int TYPE_ALL = 0;
    public static final int TYPE_FINISH = 1;
    public static final int TYPE_ING = 2;
    public UploadingAdapter3 uploadingAdapter;
    ...
    public UploadingAdapter3(Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_uploading_manager3, parent, false);
...
//        NumberProgressBarNew pbProgress;
        ...
        @Bind(R.id.id_tv_item_uploading_percent)
        TextView tvPercent;
        @Bind(R.id.id_tv_item_uploading_pay_type)
        TextView tvPayType;
...
//            Log.e("UploadingAdapter1", "setTask: "+task.progress);
        ...
        public void bind() {
            ...
            if (progress.extra1 != null && 1 == 1) {
                ...
                if (apk != null) {
                    ...
                    if (apk.getPayType().equals("免费")) {
                        tvPayType.setText(apk.getPayType());
                        tvPayType.setTextColor(Color.parseColor("#3897f9"));
                    }else {
                        tvPayType.setTextColor(Color.RED);
                        tvPayType.setText(apk.getPayType());
                    }
        ...
        public void refresh(Progress progress) {
            if (progress.extra1 != null && 1 == 1) {
                ...
                String currentPercent = percentFormat.format(progress.fraction);
...
//            netSpeed.setText("已缓存" + numberFormat.format(progress.fraction));
                tvPercent.setText("已上传"+currentPercent);
...
//                    Log.e("last_look_time", um.getLast_look_time() + "");
    ...
    public UploadingAdapter3.OnItemClickListener OnItemClickListener;

    public void OnAddItemClickListener(UploadingAdapter3.OnItemClickListener lis) {
    ...
    private class ListUploadListener extends UploadListener {
        ...
        private UploadingAdapter3.ViewHolder holder;

        ListUploadListener(Object tag, UploadingAdapter3.ViewHolder holder) {
            super(tag);
            this.holder = holder;
        }

                ...
                case 1:
                    try {
                        ...
                        if (jsonObject.getInt("status") == 1) { // 成功
                            ...
                            Toast.makeText(ShareVideoActivity.this, jsonObject.getString("errorMessage"), Toast.LENGTH_SHORT).show();
                        }
...
//                        refreshLayout.finishRefresh( false);
    ...
    public void initData(){
        ...
        map1.put("title1","步骤二");
        map1.put("title2","分享赚1积分");
        map1.put("type",1);
        data.add(map1);

        Map<String, Object> map2 = new HashMap<>();
        map2.put("title3","每日最高可赚10积分");
        map2.put("type",2);
        data.add(map2);

        bottom.setText("我要去分享");
    }
...
//                    Log.e("分享视频",result);
    ...
    public void toshare_video( ) {
        Intent intent = new Intent(ShareVideoActivity.this, CustomActivity.class);

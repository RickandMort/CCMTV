 ...
 *
 */
public class HospitalProvince extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//设置顶部导航文字
		activity_title_name.setText(R.string.hosp_prov);
		...
		Runnable runnable = new Runnable() {
			...
			public void run() {
				try {
					...
					obj.put("act", URLConfig.hosProvince);
					...
					if (json.getInt("status")==1) {
						//成功
						JSONArray array = json.getJSONArray("prov_list");
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View view, int arg2,long arg3) {
				...
				Intent intent = new Intent(HospitalProvince.this,HospitalCity.class);
				Bundle bundle = new Bundle();
				bundle.putString("provinceId", viewID.getText().toString());
				bundle.putString("provinceName", viewName.getText().toString());
		...
		public void handleMessage(Message msg) {
			...
			case 200:
				SimpleAdapter adapter = new SimpleAdapter(
						HospitalProvince.this, list, R.layout.hospital_item,

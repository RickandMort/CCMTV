 ...
 * data：2016/8/22.
 */
public class SplashWebActivity extends BaseActivity implements PlatformActionListener {
    WebView webView;
...
//        webView.addJavascriptInterface(new JSHook(), "hello"); //在JSHook类里实现javascript想调用的方法，并将其实例化传入webview, "hello"这个字串告诉javascript调用哪个实例的方法
    ...
    public void ShareWeb(View view) {
        //分享操作
        //ShareSDK.initSDK(SplashWebActivity.this);
        final ShareDialog shareDialog = new ShareDialog(SplashWebActivity.this);
        ...
        shareDialog.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1,
                ...
                if (item.get("ItemText").equals("微博")) {
                    ...
                    sinaWeibo.setPlatformActionListener(SplashWebActivity.this); // 设置分享事件回调
                    // 执行分享
                    sinaWeibo.share(sp);
                    ...
                    wechat.setPlatformActionListener(SplashWebActivity.this); // 设置分享事件回调
                    // 执行分享
                    wechat.share(sp);
                    ...
                    wechatMoments.setPlatformActionListener(SplashWebActivity.this); // 设置分享事件回调
                    // 执行分享
                    ...
                    qq.setPlatformActionListener(SplashWebActivity.this); // 设置分享事件回调
                    // 执行分享
                    qq.share(sp);
                    ...
                    qzone.setPlatformActionListener(SplashWebActivity.this); // 设置分享事件回调
                    // 执行图文分享
                    qzone.share(sp);

                } else {
                    ClipboardManager cmb = (ClipboardManager) SplashWebActivity.this
                            .getSystemService(Context.CLIPBOARD_SERVICE);
                    cmb.setText(url.trim());
                    Toast.makeText(SplashWebActivity.this, "复制成功",
    ...
    protected void onDestroy() {
        //ShareSDK.stopSDK(SplashWebActivity.this);
        super.onDestroy();
    }

...
public class AssginKsAdapter extends RecyclerView.Adapter<AssginKsAdapter.ViewHolder> implements View.OnClickListener{
    private List<AssignKsIndexEntity> data = new ArrayList<>();
    private Context mContext;
    private OnItemClickListener mItemClickListener;

    public AssginKsAdapter(Context context) {
        mContext = context;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new AssginKsAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(ViewHolder holder, int position) {
        final AssignKsIndexEntity entrty = data.get(position);
    ...
    public void refresh(List<AssignKsIndexEntity> newDatas) {
        data.clear();
    ...
    public void addData(List<AssignKsIndexEntity> newDatas) {
        if (newDatas != null) {
    ...
    public interface OnItemClickListener{
        void onItemClick(int position, AssignKsIndexEntity entrty);
    }

 ...
 */
public class Popular_search3 extends BaseActivity {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1:
                    ...
                    break;
                case 500:
                    Toast.makeText(Popular_search3.this, R.string.post_hint1, Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
            }
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (keyCode == KeyEvent.KEYCODE_ENTER && event.getAction() == KeyEvent.ACTION_DOWN) {
                    ...
                    ((InputMethodManager) getSystemService(INPUT_METHOD_SERVICE))
                            .hideSoftInputFromWindow(Popular_search3.this.getCurrentFocus()
                                    .getWindowToken(), InputMethodManager.HIDE_NOT_ALWAYS);
                    //进行搜索操作的方法，在该方法中可以加入mEditSearchUser的非空判断
                    //存储数据
                    if (search_edit.getText().toString().trim().length() > 0) {
                        //存储数据
                        MyDbUtils.saveHot_search_grid(Popular_search3.this, search_edit.getText().toString());
                        intents();
                    } else {
                        intents();
                    }
    ...
    public void intents() {
        if (mode.equals("1")) {//代表是从首页title-img进入的
            Intent intent = new Intent(Popular_search3.this, Direct_broadcast_CustomActivity.class);
            ...
            startActivity(intent);
            finish();
            Direct_broadcast_CustomActivity.isFilsh.finish();
        }
    }
    ...
    public void setText() {
        List<Hot_search_grid> list = MyDbUtils.findHot_search_grid_All(Popular_search3.this);
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    String result = HttpClientUtils.sendPost(Popular_search3.this, URLConfig.CCMTVAPP_SEARCH, obj.toString());
                    ...
                    // listview点击事件
                    trend_Search.setOnItemClickListener(new Popular_search3.casesharing_listListener());
                    hot_search_grid.setOnItemClickListener(new Popular_search3.casesharing_listListener2());
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
    ...
    private class casesharing_listListener implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> arg0, View view, int arg2, long arg3) {
            ...
            //存储数据
            MyDbUtils.saveHot_search_grid(Popular_search3.this, textView.getText().toString());
            if (mode.equals("1")) {//代表是从首页title-img进入的
                Intent intent = new Intent(Popular_search3.this, Direct_broadcast_CustomActivity.class);
                intent.putExtra("type","home");
    ...
    private class casesharing_listListener2 implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> arg0, View view, int arg2, long arg3) {
            if (isEnter) {
                ...
                //存储数据
                MyDbUtils.saveHot_search_grid(Popular_search3.this, button.getText().toString());
                if (mode.equals("1")) {//代表是从首页title-img进入的
                    Intent intent = new Intent(Popular_search3.this, Direct_broadcast_CustomActivity.class);
                    intent.putExtra("type", "home");
    ...
    public void back(View view) {
        Popular_search3.this.setResult(0, new Intent());
        finish();
    }
}

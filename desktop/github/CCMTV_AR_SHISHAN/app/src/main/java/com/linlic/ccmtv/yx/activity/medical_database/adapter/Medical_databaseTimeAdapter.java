...
public class Medical_databaseTimeAdapter extends RecyclerView.Adapter<Medical_databaseTimeAdapter.ViewHolder> {
    //动态数组
    ...
    //构造
    public Medical_databaseTimeAdapter(Context context, List<String> mList) {
        this.mList = mList;

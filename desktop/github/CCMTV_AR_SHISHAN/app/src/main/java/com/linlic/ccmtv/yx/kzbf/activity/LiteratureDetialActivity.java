 ...
 * 相关文献详情页
 */
public class LiteratureDetialActivity extends BaseActivity implements View.OnClickListener, PlatformActionListener {
    Context context;
    ...
    private RelativeLayout rl_literature_comment_title;
    private RecyclerView literature_tuijian_list, literature_comment_list;
    private ImageView literature_detial_collection_icon, literature_detial_zan_img;
    private TextView title, look_num, laud_num, literature_tuijian;
    private TextView literature_posttime, literature_auther, literature_source;
    private TextView literature_more, literature_left_txt;
    private String id;
    private String commentId;
    private String is_comment;//是否可以评论 0:可评论 1:不可评论
    private String is_laud;//是否点赞        0:未点赞 1:已点赞
    ...
    private View literature_view2;
    private MedicineDetailAdapter mdAdapter;
    private MedicineDetialCommentAdapter mdcAdapter;
    private DbMedicineComment dbMc;
    private EditText et_literature_comment;
    private LinearLayout ll_literature_write_comment;//底部评论
    private LinearLayout ll_literature_comment_collection;//收藏
    private RelativeLayout rl_literature_download;
    private LinearLayout ll_literature_comment_download;
                    ...
                    try {
                        ...
                        if (jsonObject.getString("code").equals("0")) { // 成功
                            ...
                            if (is_comment.equals("1")) {
                                ll_literature_write_comment.setVisibility(View.GONE);
                            } else {
                                ll_literature_write_comment.setVisibility(View.VISIBLE);
                            }
                            //判断是否已收藏
                            if (is_collect.equals("0")) {//变成未收藏
                                literature_detial_collection_icon.setImageResource(R.mipmap.icon_comment_collection);
                            } else {//变成已收藏
                                literature_detial_collection_icon.setImageResource(R.mipmap.icon_comment_collection2);
                            }
                            //判断是否已点赞
                            if (is_laud.equals("0")) {
                                literature_detial_zan_img.setImageResource(R.mipmap.medicine_zan);
                                literature_detial_zan_img.setClickable(true);
                            } else {
                                literature_detial_zan_img.setImageResource(R.mipmap.medicine_zan2);
                                literature_detial_zan_img.setClickable(false);
                            }

                            int commentCountNum = jsonObject.getInt("comment_count_num");
                            literature_comment.setText("全部评论(" + commentCountNum + ")");

                            //填充页面数据
                            setTextView(object, "title", title);
                            setTextView(object, "look_num", look_num);
                            setTextView(object, "laud_num", laud_num);
                            setTextView(object, "posttime", literature_posttime);
                            setTextView(object, "author", literature_auther);
                            setTextView(object, "source", literature_source);
                            ...
                            if (dataArray2.length() == 0) {//隐藏推荐
                                literature_tuijian.setVisibility(View.GONE);
                                literature_tuijian_list.setVisibility(View.GONE);
                                literature_view2.setVisibility(View.GONE);
                            } else {//显示推荐,加载数据
                                literature_tuijian.setVisibility(View.VISIBLE);
                                literature_tuijian_list.setVisibility(View.VISIBLE);
                                literature_view2.setVisibility(View.VISIBLE);
                            ...
                            if (dataArray3.length() == 0) {//隐藏评论
                                rl_literature_comment_title.setVisibility(View.GONE);
                            } else {//显示评论,加载数据
                                rl_literature_comment_title.setVisibility(View.VISIBLE);
                            ...
                            if (obj.has("name")) {
                                ...
                                literature_left_txt.setText("大小：" + file_size);
                                rl_literature_download.setVisibility(View.VISIBLE);
                                ll_literature_comment_download.setVisibility(View.VISIBLE);
                            } else {
                                rl_literature_download.setVisibility(View.INVISIBLE);
                                ll_literature_comment_download.setVisibility(View.GONE);
                            }
                    ...
                    try {
                        ...
                        if (result.getString("code").equals("0")) {//成功
                            ...
                            if (!TextUtils.isEmpty(shareUrl)) {
                                //分享操作
                                //ShareSDK.initSDK(LiteratureDetialActivity.this);
                                final ShareDialog shareDialog = new ShareDialog(LiteratureDetialActivity.this);
                                ...
                                shareDialog.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    ...
                                    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                                        ...
                                        if (item.get("ItemText").equals("微博")) {
                                            ...
                                            sinaWeibo.setPlatformActionListener(LiteratureDetialActivity.this); // 设置分享事件回调
                                            sinaWeibo.share(sp);
                                            ...
                                            wechat.setPlatformActionListener(LiteratureDetialActivity.this); // 设置分享事件回调
                                            wechat.share(sp);
                                            ...
                                            wechatMoments.setPlatformActionListener(LiteratureDetialActivity.this); // 设置分享事件回调
                                            ...
                                            qq.setPlatformActionListener(LiteratureDetialActivity.this); // 设置分享事件回调
                                            qq.share(sp);
                                            ...
                                            qzone.setPlatformActionListener(LiteratureDetialActivity.this); // 设置分享事件回调
                                            qzone.share(sp);
                                        } else {
                                            ClipboardManager cmb = (ClipboardManager) context.getSystemService(Context.CLIPBOARD_SERVICE);
                                            cmb.setText(shareUrl.trim());
                                            Toast.makeText(LiteratureDetialActivity.this, "复制成功",
...
//                    Toast.makeText(getApplicationContext(), "QQ空间分享成功", Toast.LENGTH_LONG).show();
    ...
    private TextView literature_comment;
    ...
    private void initView() {
        literature_tuijian_list = (RecyclerView) findViewById(R.id.literature_tuijian_list);
        literature_comment_list = (RecyclerView) findViewById(R.id.literature_comment_list);
        literature_detial_zan_img = (ImageView) findViewById(R.id.literature_detial_zan_img);
        title = (TextView) findViewById(R.id.literature_detial_item_title);
        look_num = (TextView) findViewById(R.id.literature_detial_eye_num);
        laud_num = (TextView) findViewById(R.id.literature_detial_zan_num);
        webView = (WebView) findViewById(R.id.literature_webView);
        literature_tuijian = (TextView) findViewById(R.id.literature_tuijian);
        rl_literature_comment_title = (RelativeLayout) findViewById(R.id.rl_literature_comment_title);

        literature_more = (TextView) findViewById(R.id.literature_more);
        literature_detial_collection_icon = (ImageView) findViewById(R.id.literature_detial_collection_icon);
        ll_literature_write_comment = (LinearLayout) findViewById(R.id.ll_literature_write_comment);
        literature_view2 = findViewById(R.id.literature_view2);
        literature_posttime = (TextView) findViewById(R.id.literature_posttime);
        literature_auther = (TextView) findViewById(R.id.literature_auther);
        literature_source = (TextView) findViewById(R.id.literature_source);
        ll_literature_comment_collection = (LinearLayout) findViewById(R.id.ll_literature_comment_collection);
        et_literature_comment = (EditText) findViewById(R.id.et_literature_comment);
        literature_left_txt = (TextView) findViewById(R.id.literature_left_txt);
        rl_literature_download = (RelativeLayout) findViewById(R.id.rl_literature_download);
        ll_literature_comment_download = (LinearLayout) findViewById(R.id.ll_literature_comment_download);
        literature_comment = (TextView) findViewById(R.id.literature_comment);
    }
...
//                    Log.e("看看文献详细数据", result);
    ...
    private void initData() {
        literature_more.setOnClickListener(this);
        literature_detial_zan_img.setOnClickListener(this);
        ll_literature_comment_collection.setOnClickListener(this);
        rl_literature_download.setOnClickListener(this);
        ll_literature_comment_download.setOnClickListener(this);
...
//        webSettings.setSupportZoom(true); // 可以缩放
        ...
        literature_tuijian_list.setLayoutManager(new LinearLayoutManager(context));
        mdAdapter = new MedicineDetailAdapter(context, listMore);
        literature_tuijian_list.setAdapter(mdAdapter);
        //相关推荐列表点击事件
        ...
        literature_comment_list.setLayoutManager(new LinearLayoutManager(context));
        mdcAdapter = new MedicineDetialCommentAdapter(context, commentMore);
        literature_comment_list.setAdapter(mdcAdapter);

        et_literature_comment.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            @Override
            public boolean onEditorAction(TextView textView, int i, KeyEvent keyEvent) {
                if (i == EditorInfo.IME_ACTION_SEND) {
                    setComment();
                    et_literature_comment.setText("");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.literature_more://跳转更多评论
                Intent intent = new Intent(context, MoreCommentActivity.class);
                intent.putExtra("aid", id);
                startActivity(intent);
                break;
            case R.id.ll_literature_comment_collection://收藏/取消收藏
                ...
                setCollection();
                break;
            case R.id.literature_detial_zan_img://赞/取消赞
                literature_detial_zan_img.setClickable(false);
                if (is_laud.equals("0")) {
                    is_laud = "1";
                } else {
                ...
                setPraise();
                break;
            case R.id.rl_literature_download:
                fileList = DownloadManager.getInstance().getAll();
                articleList = new ArrayList<>();
                IsDownload();
                break;
            case R.id.ll_literature_comment_download:
                fileList = DownloadManager.getInstance().getAll();
                articleList = new ArrayList<>();
                IsDownload();
                break;
    ...
    private void IsDownload() {
        for (int i = 0; i < fileList.size(); i++) {
            if (fileList.get(i).extra2 != null && 1 == 1) {
...
//                    Log.e("看看点赞数据", result);
    ...
    private void setComment() {
        content = et_literature_comment.getText().toString();
        Runnable runnable = new Runnable() {
            @Override
            public void run() {
                try {

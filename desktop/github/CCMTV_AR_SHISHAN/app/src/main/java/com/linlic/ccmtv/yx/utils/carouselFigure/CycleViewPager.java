package com.linlic.ccmtv.yx.utils.carouselFigure;
...
import com.linlic.ccmtv.yx.activity.home.ZoomOutPageTransformer;
import com.linlic.ccmtv.yx.utils.carouselFigure.bean.ADInfo;
import com.linlic.ccmtv.yx.widget.RoundCornerImageView;
...
//    private List<RoundCornerImageView> imageViews = new ArrayList<RoundCornerImageView>();
    ...
    public void setData(List<ImageView> views, List<ADInfo> list, ImageCycleViewListener listener, int showPosition) {
      ...
      //  viewPager.setPageMargin(40);
        ...
        viewPager.setPageTransformer(false, new ZoomOutPageTransformer());            //设置轮播图缩放特效

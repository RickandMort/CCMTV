 ...
 */
public class Video_book_Main_GridAdapter extends BaseAdapter {
	private Context mContext;
	public List<Video_book_Entity> video_book_entities;


	public Video_book_Main_GridAdapter(Context mContext, List<Video_book_Entity>  video_book_entities ) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(mContext).inflate(
					R.layout.video_book_main_gridadapter_item, parent, false);
		}

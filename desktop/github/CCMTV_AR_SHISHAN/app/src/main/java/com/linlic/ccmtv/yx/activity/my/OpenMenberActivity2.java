 ...
 * @author yu
 */
public class OpenMenberActivity2 extends BaseActivity implements OnClickListener {
    Context context;
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                try {
                                    ...
                                    String result = HttpClientUtils.sendPost(OpenMenberActivity2.this, URLConfig.CCMTVAPP, obj.toString());
...
//                            orderInfo = getOrderInfo(viptitle, viptitle, "0.01");
                            ...
                            new Thread(new Runnable() {
                                ...
                                public void run() {
                                    // 构造PayTask 对象
                                    PayTask alipay = new PayTask(OpenMenberActivity2.this);
                                    // 调用支付接口，获取支付结果
    ...
    public void initData() {
        req = new PayReq();
        sb = new StringBuffer();
        uid = SharedPreferencesTools.getUid(OpenMenberActivity2.this);
        ...
        Str_username = SharedPreferencesTools.getUserName(OpenMenberActivity2.this);
    ...
    public void onClick(View arg0) {
        ...
        switch (arg0.getId()) {
            case R.id.btn_topay:
                if ("".equals(banktype)) {
                    Toast.makeText(OpenMenberActivity2.this, "请选择支付方式！", Toast.LENGTH_LONG).show();
                    ...
                    if (isPaySupported) {
                        ...
                        Toast.makeText(OpenMenberActivity2.this, "请安装或升级微信客户端！", Toast.LENGTH_SHORT).show();
                    }
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    obj.put("uid", SharedPreferencesTools.getUid(OpenMenberActivity2.this));
                    if(DZSID.length()>0){
                        obj.put("aid", DZSID);
                    }
    ...
    public void wexinpay() {
        ...
        Toast.makeText(OpenMenberActivity2.this, "微信支付中...", Toast.LENGTH_SHORT).show();
        new Thread(new Runnable() {
            @Override
            public void run() {
                try {
                    ...
                    String result = HttpClientUtils.sendPost(OpenMenberActivity2.this, URLConfig.CCMTVAppPayNew, obj.toString());
//                    Log.e("支付",result);
                    Message message = new Message();
                    message.what = 2;
                    message.obj = result;

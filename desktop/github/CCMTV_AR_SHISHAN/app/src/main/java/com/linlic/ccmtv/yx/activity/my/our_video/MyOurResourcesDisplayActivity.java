...
public class MyOurResourcesDisplayActivity extends BaseActivity {
                ...
                case 1:
                    try {
                        ...
                        if (jsonObject.getInt("status") == 1) {
                            resourcesUrl = jsonObject.getString("pdfurl");
                            downFilepath = jsonObject.getString("url");
                            downFileName = resourcesUrl.substring(resourcesUrl.lastIndexOf("/") + 1, resourcesUrl.length());
                            LogUtil.e("文件名", downFileName);
                            resourcesTitle = jsonObject.getString("title");
...
//                                    initWeb(resourcesUrl);
                                ...
                                Toast.makeText(context, "URL地址为空", Toast.LENGTH_SHORT).show();
                            }
                        } else {
...
//                    MyProgressBarDialogTools.hide();
    ...
    private void getPermission() {
        ...
        if (hasWriteContactsPermission != PackageManager.PERMISSION_GRANTED) {
            if (!ActivityCompat.shouldShowRequestPermissionRationale(MyOurResourcesDisplayActivity.this,
                    Manifest.permission.READ_EXTERNAL_STORAGE)) {
                ActivityCompat.requestPermissions(MyOurResourcesDisplayActivity.this,

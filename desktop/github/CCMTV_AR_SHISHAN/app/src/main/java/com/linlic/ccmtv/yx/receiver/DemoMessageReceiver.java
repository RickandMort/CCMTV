...
import com.linlic.ccmtv.yx.activity.mipush.PermissionActivity;
...
public class DemoMessageReceiver extends PushMessageReceiver {
    ...
    public static boolean ismiPush = false;
    public String TAG = "小米推送";
    @Override
...
//        MainActivity.logList.add(0, getSimpleDate() + " " + log);
        ...
        msg.obj = log;
        LocalApplication.getHandler().sendMessage(msg);
    }
...
//        MainActivity.logList.add(0, getSimpleDate() + "    " + log);
    ...
    /*    Message msg = Message.obtain();
        msg.obj = log;
        LocalApplication.getHandler().sendMessage(msg);*/
            if(mRegId!=null && mRegId.length()>0){
                ismiPush = true;
                MiPushClient.setAlias(context,mRegId,null);
                SharedPreferencesTools.saveXMPush_id(context,mRegId);
                SharedPreferencesTools.savePush_Platform(context,"xiaomi");
            }
//        SharedPreferencesTools.savePush_id(context,SharedPreferencesTools.getUid(context));
            LogUtil.e("小米",log);
//        }
...
//        MiPushClient.setAlias(context,"text1",null);
        LogUtil.e("小米",log);
        if(mRegId.length()>0){
            ismiPush = true;
            MiPushClient.setAlias(context,mRegId,null);

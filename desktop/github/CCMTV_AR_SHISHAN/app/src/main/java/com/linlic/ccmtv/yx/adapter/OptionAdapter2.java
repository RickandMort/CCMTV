 ...
 */
public class OptionAdapter2 extends RecyclerView.Adapter<OptionAdapter2.Holder> {
	private Context mContext;
	public List<Option> options ;

	public OptionAdapter2(Context mContext, List<Option> options ) {
	...
	public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
		// 实例化展示的view
		View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.option_item2, parent, false);
		// 实例化viewholder

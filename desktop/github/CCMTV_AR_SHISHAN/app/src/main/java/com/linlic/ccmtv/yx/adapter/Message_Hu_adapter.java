...
/**
 * Created by bentley on 2019/6/10.
 */
...
public class Message_Hu_adapter extends BaseAdapter {
    /**
     * 上下文对象
     */
     ...
     * @param
     */
    public Message_Hu_adapter(Context ctx, List<Map<String, Object>> data, int rightWidth) {
        mContext = ctx;
        this.data = data;

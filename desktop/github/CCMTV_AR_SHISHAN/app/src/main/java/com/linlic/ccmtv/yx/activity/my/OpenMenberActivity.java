 ...
 * @author yu
 */
public class OpenMenberActivity extends BaseActivity implements OnClickListener {
    Context context;
    //微信
    public static String nonceStr, trade_no;
    TextView activity_title_name, tv_username_vip, vip_name, vip_time, tv_vip_money, tv_viptime;
    Button btn_topay;
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                try {
                                    ...
                                    String result = HttpClientUtils.sendPost(OpenMenberActivity.this, URLConfig.CCMTVAPP, obj.toString());
                    ...
                    try {
                        ...
                        if (result.getInt("status") == 1) {//成功
                            ...
                            if (PaymentActivity.payfor.equals("vip")) {
                                intent.setClass(OpenMenberActivity.this, MyOpenMenberActivity.class);
                                tv_viptime.setText("套餐时长:");
                            } else if (PaymentActivity.payfor.equals("inte")) {
                                intent.setClass(OpenMenberActivity.this, Integral.class);
...
//                            orderInfo = getOrderInfo(viptitle, viptitle, "0.01");
                            ...
                            new Thread(new Runnable() {
                                ...
                                public void run() {
                                    // 构造PayTask 对象
                                    PayTask alipay = new PayTask(OpenMenberActivity.this);
                                    // 调用支付接口，获取支付结果
    ...
    public void setText() {
        ...
        if (PaymentActivity.payfor.equals("vip")) {
            ...
            tv_viptime.setText("积分数量:");
        }else if(PaymentActivity.payfor.equals("book")){
            tv_viptime.setText("套餐内容:");
        }
    ...
    public void initData() {
        req = new PayReq();
        sb = new StringBuffer();
        uid = SharedPreferencesTools.getUid(OpenMenberActivity.this);
        ...
        Str_username = SharedPreferencesTools.getUserName(OpenMenberActivity.this);
    ...
    public void onClick(View arg0) {
        ...
        switch (arg0.getId()) {
            case R.id.btn_topay:
                if ("".equals(banktype)) {
                    Toast.makeText(OpenMenberActivity.this, "请选择支付方式！", Toast.LENGTH_LONG).show();
                    ...
                    if (isPaySupported) {
                        ...
                        Toast.makeText(OpenMenberActivity.this, "请安装或升级微信客户端！", Toast.LENGTH_SHORT).show();
                    }
            ...
            case R.id.iv_pay_weixin:// 选择微信
                iv_pay_weixin.setImageResource(R.mipmap.delete_item_select2);
            ...
            case R.id.iv_pay_cashier:// 选择余额
                iv_pay_cashier.setImageResource(R.mipmap.delete_item_select2);
            ...
            case R.id.iv_pay_zhifubao:// 选择支付宝
                iv_pay_weixin.setImageResource(R.mipmap.ic_round_notselected);
                iv_pay_cashier.setImageResource(R.mipmap.ic_round_notselected);
                iv_pay_zhifubao.setImageResource(R.mipmap.delete_item_select2);
                banktype = "alipay";
                break;
            default:
                break;
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    obj.put("uid", SharedPreferencesTools.getUid(OpenMenberActivity.this));
                    if(DZSID.length()>0){
                        obj.put("aid", DZSID);
                    }
    ...
    public void wexinpay() {
        ...
        Toast.makeText(OpenMenberActivity.this, "微信支付中...", Toast.LENGTH_SHORT).show();
        new Thread(new Runnable() {
            @Override
            public void run() {
                try {
                    ...
                    String result = HttpClientUtils.sendPost(OpenMenberActivity.this, URLConfig.CCMTVAppPayNew, obj.toString());
//                    Log.e("支付",result);
                    Message message = new Message();
                    message.what = 2;
                    message.obj = result;

...
public class Select_teaching extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.select_staff3);
        context = this;
    ...
    private void initViews() {
        List<Resident> rs =   (List<Resident>) getIntent().getSerializableExtra("teaching_data");//获取list方式
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //设置返回数据
                Select_teaching.this.setResult( Activity.RESULT_OK, intent);
                finish();
            }
        });
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    obj.put("act", URLConfig.getTeachers);

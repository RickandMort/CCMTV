...
/**
 * Created by tom on 2017/12/27. 政策法规
 */

public class Policies_and_regulations2 extends BaseActivity {
    ...
    private int page = 1;
    private TextView activity_collection_list;
                ...
                case 1:
                    try {
                        ...
                        if (jsonObject.getInt("status") == 1) { // 成功
                            ...
                            isNoMore = true;
                            Toast.makeText(Policies_and_regulations2.this, jsonObject.getString("errorMessage"), Toast.LENGTH_SHORT).show();
                        }
    ...
    public void findId() {
        ...
        activity_collection_list = (TextView) findViewById(R.id.activity_collection_list);
        activity_collection_list.setVisibility(View.GONE);

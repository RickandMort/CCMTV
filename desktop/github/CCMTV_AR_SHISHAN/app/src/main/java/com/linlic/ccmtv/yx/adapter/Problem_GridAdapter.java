 ...
 */
public class Problem_GridAdapter extends RecyclerView.Adapter<Problem_GridAdapter.Holder> {
	private Context mContext;
	public List<Problem> problems ;
	private int list_position ;

	public Problem_GridAdapter(Context mContext, List<Problem> problems, int position ) {
	...
	public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
		// 实例化展示的view
		View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.public_topic_type_problem, parent, false);
		// 实例化viewholder
				...
				switch (i){
					case 0:
						...
						if(Integer.parseInt( problems.get(position).getOptions().get(0).getOption_type()) ==0){
							...
							holder.public_topic_radio_text01.setTextColor(mContext.getResources().getColor(R.color.no_select_text_color) );
						}else if (Integer.parseInt(problems.get(position).getOptions().get(0).getOption_type()) ==1){
							holder.public_topic_radio_id01.setBackground(mContext.getResources().getDrawable(R.mipmap.exams2_10));
							holder.public_topic_radio_text01.setTextColor(mContext.getResources().getColor(R.color.exams_list_item_text_color4) );
						}
					...
					case 1:
						...
						if(Integer.parseInt( problems.get(position).getOptions().get(1).getOption_type()) ==0){
							...
							holder.public_topic_radio_text02.setTextColor(mContext.getResources().getColor(R.color.no_select_text_color) );
						}else if (Integer.parseInt(problems.get(position).getOptions().get(1).getOption_type()) ==1){
							holder.public_topic_radio_id02.setBackground(mContext.getResources().getDrawable(R.mipmap.exams2_10));
							holder.public_topic_radio_text02.setTextColor(mContext.getResources().getColor(R.color.exams_list_item_text_color4) );
						}
					...
					case 2:
						...
						if(Integer.parseInt( problems.get(position).getOptions().get(2).getOption_type()) ==0){
							...
							holder.public_topic_radio_text03.setTextColor(mContext.getResources().getColor(R.color.no_select_text_color) );
						}else if (Integer.parseInt(problems.get(position).getOptions().get(2).getOption_type()) ==1){
							holder.public_topic_radio_id03.setBackground(mContext.getResources().getDrawable(R.mipmap.exams2_10));
							holder.public_topic_radio_text03.setTextColor(mContext.getResources().getColor(R.color.exams_list_item_text_color4) );
						}
					...
					case 3:
						...
						if(Integer.parseInt( problems.get(position).getOptions().get(3).getOption_type()) ==0){
							...
							holder.public_topic_radio_text04.setTextColor(mContext.getResources().getColor(R.color.no_select_text_color) );
						}else if (Integer.parseInt(problems.get(position).getOptions().get(3).getOption_type()) ==1){
							holder.public_topic_radio_id04.setBackground(mContext.getResources().getDrawable(R.mipmap.exams2_10));
							holder.public_topic_radio_text04.setTextColor(mContext.getResources().getColor(R.color.exams_list_item_text_color4) );
						}
					...
					case 4:
						...
						if(Integer.parseInt( problems.get(position).getOptions().get(4).getOption_type()) ==0){
							...
							holder.public_topic_radio_text05.setTextColor(mContext.getResources().getColor(R.color.no_select_text_color) );
						}else if (Integer.parseInt(problems.get(position).getOptions().get(4).getOption_type()) ==1){
							holder.public_topic_radio_id05.setBackground(mContext.getResources().getDrawable(R.mipmap.exams2_10));
							holder.public_topic_radio_text05.setTextColor(mContext.getResources().getColor(R.color.exams_list_item_text_color4) );
						}
					...
					case 5:
						...
						if(Integer.parseInt( problems.get(position).getOptions().get(5).getOption_type()) ==0){
							...
							holder.public_topic_radio_text06.setTextColor(mContext.getResources().getColor(R.color.no_select_text_color) );
						}else if (Integer.parseInt(problems.get(position).getOptions().get(5).getOption_type()) ==1){
							holder.public_topic_radio_id06.setBackground(mContext.getResources().getDrawable(R.mipmap.exams2_10));
							holder.public_topic_radio_text06.setTextColor(mContext.getResources().getColor(R.color.exams_list_item_text_color4) );
						}
					...
					case 6:
						...
						if(Integer.parseInt( problems.get(position).getOptions().get(6).getOption_type()) ==0){
							...
							holder.public_topic_radio_text07.setTextColor(mContext.getResources().getColor(R.color.no_select_text_color) );
						}else if (Integer.parseInt(problems.get(position).getOptions().get(6).getOption_type()) ==1){
							holder.public_topic_radio_id07.setBackground(mContext.getResources().getDrawable(R.mipmap.exams2_10));
							holder.public_topic_radio_text07.setTextColor(mContext.getResources().getColor(R.color.exams_list_item_text_color4) );
						}
					...
					case 7:
						...
						if(Integer.parseInt( problems.get(position).getOptions().get(7).getOption_type()) ==0){
							...
							holder.public_topic_radio_text08.setTextColor(mContext.getResources().getColor(R.color.no_select_text_color) );
						}else if (Integer.parseInt(problems.get(position).getOptions().get(7).getOption_type()) ==1){
							holder.public_topic_radio_id08.setBackground(mContext.getResources().getDrawable(R.mipmap.exams2_10));
							holder.public_topic_radio_text08.setTextColor(mContext.getResources().getColor(R.color.exams_list_item_text_color4) );
						}

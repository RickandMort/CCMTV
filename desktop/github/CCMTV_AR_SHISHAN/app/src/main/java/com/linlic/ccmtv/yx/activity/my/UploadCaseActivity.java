...
//                        refreshLayout.finishRefresh( false);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = this;
        findId();
        super.setActivity_title_name("上传病例");
        initData();
        initView();
        setmsgdb();
    }
...
//                    Log.e("分享视频",result);
    ...
    public void upload_case( ) {
        Intent intent = new Intent(UploadCaseActivity.this, Upload_case3.class);

...
public class Feedback_details extends BaseActivity{
    ...
    private String id = "";
    @Bind(R.id.title)//日期img
            TextView title;
    @Bind(R.id.webView)//日期img
            WebView webView;
                ...
                case 1:
                    try {
                        ...
                        if (jsonObject.getInt("status") == 1) { // 成功
                            ...
                            //  加载、并显示HTML代码
                            webView.loadDataWithBaseURL(null, jsonObject.getJSONObject("data").getString("content") + "<script>  document.body.style.lineHeight = 1.5< /script> \\n< /html>", "text/html", "utf-8", null);
...
//        webView.loadUrl("file:///android_asset/index.html");
    ...
    private void commonQuestionDetail() {
            ...
            Runnable runnable = new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        obj.put("act", URLConfig.commonQuestionDetail);

...
public class ConferenceTimeAdapter extends RecyclerView.Adapter<ConferenceTimeAdapter.ViewHolder> {
    //动态数组
    ...
    //构造
    public ConferenceTimeAdapter(Context context, List<String> mList) {
        this.mList = mList;

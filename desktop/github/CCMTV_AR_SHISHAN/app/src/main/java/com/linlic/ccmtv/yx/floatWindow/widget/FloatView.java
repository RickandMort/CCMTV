...
import com.linlic.ccmtv.yx.floatWindow.utils.MyBroadCastReceiver;
import com.linlic.ccmtv.yx.floatWindow.utils.ResourceUtils;
...
//    private ImageView mIvFloatLoader;
    ...
    private ImageView user_icon, extend, close_icon;
...
//                context, "pj_float_view_icon_notify"));
        mLlFloatMenu = (LinearLayout) rootFloatView.findViewById(ResourceUtils.getId(
                context, "ll_menu"));
        extend = (ImageView) rootFloatView.findViewById(ResourceUtils.getId(
                context, "extend"));
        extend.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), Float_Main.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                context.startActivity(intent);
            }
        });
        user_icon = (ImageView) rootFloatView.findViewById(ResourceUtils.getId(
                context, "user_icon"));
        close_icon = (ImageView) rootFloatView.findViewById(ResourceUtils.getId(
                context, "close_icon"));
        ...
        title_Layout = (LinearLayout) rootFloatView.findViewById(ResourceUtils.getId(
                context, "title_Layout"));
        title_Layout.setOnTouchListener(this);
        user_icon.setOnTouchListener(this);
        mLlFloatMenu.setOnTouchListener(this);
        mTvAccount = (TextView) rootFloatView.findViewById(ResourceUtils.getId(
                context, "tv_account"));
        mTvAccount.setOnTouchListener(this);
        ...
        mTvFeedback = (TextView) rootFloatView.findViewById(ResourceUtils.getId(context, "tv_feedback"));
        mTvFeedback2 = (TextView) rootFloatView.findViewById(ResourceUtils.getId(context, "tv_feedback2"));
        /*mTvFeedback.setOnTouchListener(this);
...
//        playingmusic(FloatLayout.PAUSE_MUSIC);
    ...
    public void setMusicTime(String currTime, String totalTime) {
        //启动服务，播放音乐
        mTvFeedback.setText(currTime);
        mTvFeedback2.setText(totalTime);
    }

    public void setImage() {
        com.linlic.ccmtv.yx.util.ImageLoader.load(mContext, FloatLayout.imgUrl, user_icon);

    }

    public void setTitle() {
        mTvAccount.setText(FloatLayout.title);
        setTextMarquee(mTvAccount);
    }

 ...
 * 2016-3-2下午7:02:48
 */
public class VideoFive extends AppCompatActivity implements DetailFragment.Callback, OnGestureListener, PlatformActionListener, OnClickListener, NetBroadcastReceiver.NetEvevt {
    ...
    private static final String LOG_TAG = VideoFive.class.getSimpleName();
    //视频aid
    ...
    public static VideoFive isFinish;
                ...
                case 1:
                    try {
                        ...
                        if (result.getInt("status") == 1) { // 成功
                            ...
                            videoplaystyle = dataArray.getString("videoplaystyle");//播放器选择标识  smvp 为石山播放器  ccmtv为本地播放器noresource无数据及视频资源丢失
                            ...
                            ImageLoader.getInstance().displayImage(FirstLetter.getSpells(SharedPreferencesTools.getStricon(VideoFive.this)), MyImg);
                            ImageLoader.getInstance().displayImage(FirstLetter.getSpells(SharedPreferencesTools.getStricon(VideoFive.this)), MyImg2);
                            initFragment();
                ...
                case 4://取消赞
                    ...
                    try {
                        ...
                        if (result.getInt("status") == 1) {// 成功
                            ...
                            Toast.makeText(VideoFive.this, result.getString("errorMessage"), Toast.LENGTH_SHORT).show();
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    ...
                    try {
                        ...
                        if (result.getInt("status") == 1) {//成功
                            ...
                            if (!TextUtils.isEmpty(dataurl)) {
                                //分享操作
                                //ShareSDK.initSDK(VideoFive.this);
                                final ShareDialog shareDialog = new ShareDialog(VideoFive.this);
                                ...
                                shareDialog.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    ...
                                    public void onItemClick(AdapterView<?> arg0, View arg1,
                                        ...
                                        if (item.get("ItemText").equals("微博")) {
                                            ...
                                            sinaWeibo.setPlatformActionListener(VideoFive.this); // 设置分享事件回调
                                            sinaWeibo.share(sp);
...
//                                            sp.setUrl("https://www.baidu.com/");   //网友点进链接后，可以看到分享的详情
                                            ...
                                            wechat.setPlatformActionListener(VideoFive.this); // 设置分享事件回调
                                            wechat.share(sp);
                                            ...
                                            wechatMoments.setPlatformActionListener(VideoFive.this); // 设置分享事件回调
                                            ...
                                            qq.setPlatformActionListener(VideoFive.this); // 设置分享事件回调
                                            qq.share(sp);
                                            ...
                                            qzone.setPlatformActionListener(VideoFive.this); // 设置分享事件回调
                                            qzone.share(sp);
                                        } else {
                                            ClipboardManager cmb = (ClipboardManager) context.getSystemService(Context.CLIPBOARD_SERVICE);
                                            cmb.setText(dataurl.trim());
                                            Toast.makeText(VideoFive.this, "复制成功", Toast.LENGTH_LONG).show();
                                        }
                                        shareDialog.dismiss();
                                    }
                                });
                ...
                case 14:
                    try {
                        ...
                        if (result.getInt("status") == 1) {// 成功
                            ...
                            //跳转页面
                            Intent intent = new Intent(VideoFive.this, VideoFive.class);
                ...
                case 18:
                    try {
                        ...
                        if (result.getInt("status") == 1) {
                            ...
                            VideoFive.toast(VideoFive.this, result.getString("errorMessage"));
                        } else {// 失败
                            Toast.makeText(VideoFive.this, result.getString("errorMessage"), Toast.LENGTH_SHORT).show();
                        }
                    } catch (Exception e) {
                    ...
                    if (experts.size() > 0) {
                        for (Video_menu_expert expert : experts) {
                            ...
                            nameView.setOnClickListener(new OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    Intent intent = new Intent(VideoFive.this, PlayVideo_expert.class);
                                    intent.putExtra("aid", v.getTag().toString());
                                    intent.putExtra("fid", fid);
                                    VideoFive.this.startActivity(intent);
                                }
                            });
...
//        setcomment();
    ...
    public void inspectNet() {
        //启动时判断网络状态
        NETWORK = NetUtil.getNetWorkState(VideoFive.this);
    }
...
//            controller.setTitle("");
            ...
            options.placeholder(R.mipmap.ys);
            Glide.with(this)
                    .load(picurl)
                    .apply(options)
...
//                helper.setcommreply(R.id.video_menu_comment_reply, ((Video_menu_comment_entry2) item).getVideo_menu_comment_item_name(), ((Video_menu_comment_entry2) item).getVideo_menu_comment_item_cid());
                ...
                //删除
                helper.setCommentAdapterDelOnClick3(R.id.video_menu_comment_delete, VideoFive.this);
                String delid = "";
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    String result = HttpClientUtils.sendPost(VideoFive.this, URLConfig.CCMTVAPP, obj.toString());
            ...
            video_editext_submit.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (!video_menu_comment_edittext.getText().toString().trim().equals("")) {
                        ...
                        runOnUiThread(new Runnable() {
                            public void run() {
                                Toast.makeText(VideoFive.this, "内容不能为空！", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                }
...
//                    Log.e("用户是否需要完善资料：", result);
                    ...
                    if (jsonObject.has("data")) {
                        ...
                        if (completeStatus.equals("need")) {
                            Intent intent = new Intent(VideoFive.this, MyProfile.class);
                            intent.putExtra("source", "videoFive");
                            intent.putExtra("aid", aid);
                            startActivity(intent);
                            finish();
                        }
...
//                LogUtil.e("视频播放",fid+"    "+activity_title_name.getText().toString().trim().length());
...
//                 getIntegraldDeductionRulest();
                ...
                try {
                    ...
                    if (!"0".equals(videopaymoney)) {
                        ...
                        //       Log.e("IMG", "不是收费视频");
                        //不是收费视频
                        if (SharedPreferencesTools.getVipFlag(VideoFive.this) == 1) {
                            //VIP
//                            playVideo();
                            getIntegraldDeductionRulest();
                        } else {
...
//                    Log.e("videopaymoney",videopaymoney);
            ...
            case R.id.video_icon_download_layout:
                ...
                if (flag == 5) {
                    ...
                    // 弹出自定义dialog
                    LayoutInflater inflater = LayoutInflater.from(VideoFive.this);
                    View views = inflater.inflate(R.layout.dialog_item6, null);

                    // 对话框
                    dialog = new Dialog(VideoFive.this);
                    dialog.getWindow().setBackgroundDrawable(new ColorDrawable(0));
                    dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
                    dialog.show();
                    // 设置宽度为屏幕的宽度
                        ...
                        if (model == null) {
                            ...
                            if (video.size() > 0) {
                                ...
                                if (!videopaymoney.equals("0")) {
                                    ...
                                    if (SharedPreferencesTools.getVipFlag(VideoFive.this) == 1) {//是会员
                                        getDownloadRulest();
                                    } else {
                    ...
                    if (isdowen) {
                        //不是会员
                        AlertDialog.Builder builder = new AlertDialog.Builder(VideoFive.this);
    ...
    public void toAbstract(View v) {
        Intent intent = new Intent(VideoFive.this, PlayVideo_abstract.class);
        intent.putExtra("aid", aid);
        intent.putExtra("fid", fid);
        startActivity(intent);
    }
                    ...
                    .setSingleChoiceItems(definitions, 0, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            try {
                                ...
                                ((VideoFive) getActivity()).download(definition);
                                dialog.dismiss();
                            } catch (Exception e) {
...
//                MyLogger.w(LOG_TAG, "videoId can't be null or empty");
            ...
            if (MyDbUtils.findRecordVideo(context, my_video_id) > 0) {
                ...
                final Dialog dialog = new Dialog(VideoFive.this, R.style.ActionSheetDialogStyle);
...
//            if (SDKConstants.ACTION_PLAY_PROGRESS_CHANGED == action) {
            ...
            myPlayprogress += 1;
            Log.d("snow","onReceive call   == " + playprogress);
            ...
            if (!"0".equals(videopaymoney)) {
                ...
                if (payBoolean > 0) {
                    if (progress > 50) {
                        ...
                        if (mVideoView.isFullScreen()) {
                            //变小屏
                            VideoFive.this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_SENSOR_PORTRAIT);
                            runOnUiThread(new Runnable() {
                                public void run() {
                                    arrow_back2.setVisibility(View.VISIBLE);
                                }
    ...
    private void judgeNetWork(final String fluentFile, final String SDFile, final String hdefinitionFile) {
         ...
         */
            final AlertDialog.Builder normalDialog =
                    new AlertDialog.Builder(VideoFive.this);
            ...
            normalDialog.setNegativeButton("取消下载",
                    new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Toast.makeText(VideoFive.this, "取消下载", Toast.LENGTH_SHORT).show();
                        }
                    });
            // 显示
            normalDialog.show();

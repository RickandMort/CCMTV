 ...
 */
public abstract class BaseListAdapter2<T> extends BaseAdapter implements
    ...
    public void setmDatas( Collection<T> mDatas){
        this.mDatas = mDatas;
    }

    public BaseListAdapter2(AbsListView view, Collection<T> mDatas, int itemLayoutId) {
        if (mDatas == null) {

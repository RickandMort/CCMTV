...
public class PeriodicalExamPicGridViewAdapter extends BaseAdapter {
    private PeriodicalExamActivity context;
    private List<PhotoInfo> list;
    private String disabled = "1";

    public PeriodicalExamPicGridViewAdapter(PeriodicalExamActivity context, List<PhotoInfo> list) {
